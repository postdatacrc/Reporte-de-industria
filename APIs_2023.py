...
def ReadApiTelMovilAbonados():
    ...
    consulta='https://www.postdata.gov.co/api/action/datastore/search.json?resource_id=' + resourceid + ''\
             '&filters[anno]=' + '2019,2020,2021,2022' + ''\
...
def ReadApiIMAccesos():
    ...
    consulta_cf='https://www.postdata.gov.co/api/action/datastore/search.json?resource_id=' + resourceid_cf + ''\
                '&filters[anno]=' + '2019,2020,2021,2022' + ''+'&filters[mes_del_trimestre]=3'\
                '&fields[]=anno&fields[]=trimestre&fields[]=id_empresa&fields[]=empresa'\
                '&group_by=anno,trimestre,id_empresa,empresa'\
...
def ReadApiINTFAccesosCorp():
    consulta_anno='2019','2020','2021','2022'
...
##Ingresos
def ReadAPIIngTF():
    resourceid_tl_ing = '8b0fc631-461c-4a09-bb86-b5d591265e71'
    consulta_anno='2018,2019,2020,2021,2022'
    ...
    TL_ING['modalidad']='Fija nacional'
    return TL_ING  
IngTelFija=ReadAPIIngTF()
...
def ReadAPIIngTLDI():
    ...
    return TL_ING 
IngTelFijaNac=ReadAPIIngTF()
IngresosTelefoniaLDI=ReadAPIIngTLDI()
IngresosTelefoniaFija=pd.concat([IngTelFijaNac,IngresosTelefoniaLDI])
